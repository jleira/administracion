...
<body>
  ...
  <td  colspan="7" rowspan="2" style="font-size: 15px;text-align:center;background-color: #792929;margin: 25px !important;padding: 15px;color: #fffff !important">        <h3 >{{validarlista($categoria,4)}} - {{formatofecha($fecha_inicio)}} / {{formatofecha($fecha_fin)}}</h3>
